...
package lib.com.sun.net.httpserver.spi;
...
public abstract class HttpServerProvider {
     ...
     *   {@code lib.com.sun.net.httpserver.HttpServerProvider} is defined then it
     ...
     *   {@code lib.com.sun.net.httpserver.HttpServerProvider} in the resource
                ...
                .doPrivileged(new PrivilegedAction<Object>() {
                        public Object run() {
                            ...
                            if (loadProviderAsService())
                                return provider;
                            provider = new lib.sun.net.httpserver.DefaultHttpServerProvider();
                            return provider;
                        }
                    });
        }
